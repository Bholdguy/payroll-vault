...
result: settled x402 machine payments are recorded
into the on-chain agent earnings ledger. x402 settlement demonstrated on casper testnet; automatic recording wired, final end-to-end run pending.
